...
# Declaring variables
my $vocinfile='E:\24_naxi\Yongning\F4_LD_AMA\F4_tons\fichiers_archives\Composition\Tone_Peoples_1_F4_2006.txt';
#my $vocinfile = 'E:\24_naxi\Yongning\F4_LD_AMA\F4_tons\fichiers_archives\Composition\test.txt';
my $regionsinfile = 'E:\24_naxi\Yongning\F4_LD_AMA\F4_tons\fichiers_archives\Composition\Tone_Peoples_1_F4_2006_REGIONS.txt'; 
...
while ($line=<VOC>) {
		...
		# writing the determiner into the file
			print  XOUT "\t<NOTE xml:lang=\"en\" message=\"Determiner: $det\"/>\n";
		}
		...
		if ($head eq 'x') {       #this is not a determinative compound and no information is written. 
			...
			print  XOUT "\t<NOTE xml:lang=\"en\" message=\"Head: $head\"/>\n";
		}		
