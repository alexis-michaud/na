...
The Na (Moso) are famous among ethnologists and anthropologists (and even among a wider public) for their family structures. Cai Hua depicts them as ‘a society without fathers or husbands’ \parencite{cai1997}, but one of his readers \parencite[147]{wellens2003} points out that, in his desire to paint the portrait of a family structure diametrically opposed to the Chinese (Han) model, he brushes aside quietly those observations that do not accord with the sweeping generalization summed up in the title of his work. Since the earliest ethnological studies in China \parencite{zhanetal1980,zhanyanetal1983,weng1993,shih1993,shih2010}, the Na have more appropriately been described as an exemplary case of matrilineal and matrilocal societies. Yet even these studies tend to interpret family structures rigidly on the basis of lineage theories, even though they describe a diversity of practices that calls this approach into question. Detailed ethnography of Na villages \parencite{milan_na_2016,milan_tourisme_2019} leads specialists to engage in the project of understanding Na society in its areal context (the Sino-Tibetan marches, where remarkable diversity is found in kinship), rather than through the lens of an abstract system of binary oppositions \parencite{cai2008}. Instead of focusing on a classification based on notions such as ‘matrilineality’, whose clarity turns out to be only apparent, it is enlightening to approach family structures in terms of the dynamics of the household. This perspective originates in early criticisms of the lineage paradigm -- criticisms which need to be kept in mind in any presentation of Na family structures \parencite{zhou_zigong_2003,hosana_2006}. The various forms of cohabitation and marriage are thus strategies for the social reproduction of houses under various political regimes, at various historical times (starting well before the communist regime took power in 1958). \emph{Taking a wife} (\emph{chumi shei}) from another house is a way for a house to ensure its balance and continuity.\footnote{This strand of research is pursued in a talk by Pascale-Marie Milan, “Gender balance strategies and social engineering pressures: ‘Taking wives' (chumi shei) in the context of the Na family of Lijiazui in feudal times and in present-day China”, presented at the workshop “Family resemblances: kinship practices along the Sino-Tibetan borderlands”, CNRS-École Française d'Extrême-Orient, October 2024.} The study of the Na and neighbouring peoples is a vibrant field of research, contributing, decade after decade, to an in-depth renewal of approaches to the anthropology of kinship and family. The rapid development of tourism in recent years in the Lugu Lake area fosters new strands of research which shed further light on family organization as seen through its response to social change \parencite{walsh_living_2001,mattison2010,milan_tourisme_2019}(Mattison 2010; Milan 2019; Walsh 2001).

By contrast, until the 21st century, much less attention was directed to the language spoken by the Na, which has fascinating properties, such as its elaborate morphotonology: tones play a role in the entire grammatical system. The present dictionary is part of a wider effort to produce substantial, reliable documentation on the Yongning Na language.
...
First and foremost, special thanks to Latami Dashilamu \pcmn{拉他咪打史拉姆}, reference speaker and co-author of this work, for the motivation, perseverance and generosity with which she has been engaged in our collaboration since 2006. My warm thanks to her son Latami Dashi \pcmn{拉他咪王勇（拉他咪达石）} for encouraging and supporting my work with his mother, and for giving the dictionary the benefit of his expert knowledge about Na society. My thanks to all family members for their patience and good humour over the years.
