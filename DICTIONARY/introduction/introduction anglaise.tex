...
The Na (Moso) are famous among ethnologists and anthropologists (and even among a wider public) for their family structures. Cai Hua depicts them as ‘a society without fathers or husbands’ \parencite{cai1997}, but one of his readers \parencite[147]{wellens2003} points out that, in his desire to demonstrate, he brushes aside quietly those observations that do not accord with the sweeping generalization summed up in the title of his work. This slight oversimplification allows Cai Hua to paint the portrait of a family structure diametrically opposed to the Chinese (Han) model, but such black-and-white contrasts, helpful as they can be, do not yield a fine-grained view of actual situations. Detailed ethnography of Na villages leads specialists to qualify the idea of a society without marriage, and to engage in the project of understanding Na society in its areal context (the Sino-Tibetan marches, where remarkable diversity is found in kinship), rather than through the lens of an abstract system of binary oppositions. Instead of focusing on a classification based on notions such as ‘matrilineality’, whose clarity turns out to be only apparent, it is enlightening to approach family structures in terms of the dynamics of the household. This perspective makes it possible to understand how marriage has (since long before Communist takeover in the mid-1950s) fulfilled certain functions in the organization of Na families: one household \emph{takes a wife} (\emph{chumi shei}) from another household, in order to ensure its balance and continuity.\footnote{This strand of research is pursued in a talk by Pascale-Marie Milan, “Gender balance strategies and social engineering pressures: ‘Taking wives‘ (chumi shei) in the context of the Na family of Lijiazui in feudal times and in present-day China”, presented at the workshop “Family resemblances: kinship practices along the Sino-Tibetan borderlands”, CNRS-École Française d'Extrême-Orient, October 2024.} Clearly, the study of the Na and neighbouring peoples is a vibrant field of research, contributing, decade after decade, to an in-depth renewal of approaches to the anthropology of kinship and family.
