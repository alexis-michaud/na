...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:exslt="http://exslt.org/common" xmlns:regexp="http://exslt.org/regular-expressions">
    ...
    <!-- Les trois langues du dictionnaire : na, chinois, français -->
    ...
    <!-- En-tête LaTeX : 'packages', et commandes définies dans ce document -->
    <xsl:template match="RessourceLexicale">
        ...
        \newcommand{\ton}[1]{\pfra{Ton:~}\prin{#1}\hspace{0.5cm}}
        \newcommand{\classe}[1]{\pfra{\textcolor{OliveGreen}{\textsc{#1}}}}
        \newcommand{\usage}[1]{\pfra{\textit{#1}}}
        \newcommand{\commentaire}[1]{\pfra{({#1}) }}
        \newcommand{\paradigme}[2]{\pfra{#1}\pnru{#2}}
        \newcommand{\relationsémantique}[2]{\pfra{#1}\pnru{#2}}
        ...
        \newcommand{\étiquette}[1]{\pfra{~Synonyme:~\pnru{#1}}}
        \newcommand{\synonyme}[1]{\pfra{~Synonyme:~\pnru{#1}}}
        \newcommand{\antonyme}[1]{\pfra{~Antonyme:~\pnru{#1}}}
        \newcommand{\confer}[1]{\pfra{~Voir~\pnru{#1}}}
        \newcommand{\emprunt}[1]{\pfra{~Emprunt:~#1}}
        \newcommand{\étymologie}[1]{\pfra{~Étymologie:~\pnru{#1}}}
        \newcommand{\utilisation}[1]{\pfra{Usage: #1}}
    ...
    <xsl:template match="Sens">
        ...
        <xsl:apply-templates select="Définition[ReprésentationDeTexte[@langue!='eng']]"/>
...
<xsl:template match="Définition">
    <!-- <xsl:template match="Définition[not(@langue='eng')]"> -->
	<!-- <xsl:template match="Définition[ReprésentationDeTexte[@langue!='eng']]"> -->
        <xsl:text>&#10;</xsl:text>
    ...
    <xsl:template match="Exemple">
        ...
        <xsl:for-each select="ReprésentationDeTexte[not(@langue='eng')]">
            <xsl:text>\p</xsl:text>
